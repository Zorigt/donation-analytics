        ...
        for donation in donations:
            ...
            if donation_array[15] == '':
                ...
                if recipient and zipcode and year and name and amount:
                    ...
                    found_recipient, found_zipcode_year, found_name, found_prev_yr_don = check_donation.checkDonation(concise_donation_array, alpha_num_array, num_array, name_array)
                    if found_recipient != '' and found_zipcode_year != '' and found_name != '' and found_prev_yr_don != '':
                        print(found_recipient, found_zipcode_year, found_name, found_prev_yr_don)
                        temp = recipient_zipcode_year.RecipientZipcodeYear(found_recipient)
                        a = found_recipient + found_zipcode_year
                        print('the object =',a)
                        if a != '':
                            exec(a + "= temp")
